package com.codewithanny.billingservice.kafka;
...
public class KafkaConsumer {
    ...
    public void consumeEvent(byte[] event) {
        try {
            ...
            log.info("Received billing account event: [StudentId={}, StudentName={}, StudentEmail={}]",
                    billingAccountEvent.getStudentId(),
                    billingAccountEvent.getName(),
                    billingAccountEvent.getEmail());

            // check if the student billing account doesn't exist, if not then create it
